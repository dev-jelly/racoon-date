    ...
    <Box my={4}>
      ...
      <Box>
        ...
        <Box
          ...
          alignItems={"center"}
        >
          <Link to={locationUrl + breakfastUrl}>
            <SelectButton buttonText={"아침도 같이 먹자!"} />
          </Link>
          <Link to={locationUrl + morningUrl}>
            <SelectButton buttonText={"아침부터 만나자!"} />
          </Link>
          <Link to={locationUrl + lunchUrl}>
            <SelectButton buttonText={"점심에 보자!"} />
          </Link>
          <Link to={locationUrl + afternoonUrl}>
            <SelectButton buttonText={"점심먹고 보자!"} />
          </Link>
          <Link to={locationUrl + dinnerUrl}>
